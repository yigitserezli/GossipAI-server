...
export const TRANSLATIONS: Record<LandingLanguage, LandingCopy> = {
  tr: {
    ...
    featuresRealmHeadingLine2: "İçgörü",
    featuresRealmHeadingLine3: "Alanı",
    featuresRealmDescription: "Hayatının farklı alanlarında iletişimi daha net okumak ve yönetmek için derin analiz al.",
    featuresRealmPersonalTitle: "Kişisel Hayat İçgörüleri",
    featuresRealmPersonalDescription:
      "Karışık sinyalleri çöz, süren gerilimleri daha doğru oku ve arkadaşlık ile romantik konuşmalardaki alt metni netleştir.",
    featuresRealmProfessionalTitle: "Profesyonel Strateji",
    featuresRealmProfessionalDescription:
      "Ofis dinamiklerini daha iyi yorumla, kritik toplantılarda tonu doğru kur ve kariyer iletişimini daha kontrollü yönet.",
    valueTag: "Neden tercih ediliyor",
    valueHeading: "Mesaj hızını koru, net kal",
    valueDescription: "Günlük akışta hızlı kalırken tonunu, niyetini ve netliğini korumana yardımcı olur.",
    valueBullets: [
      "Sana benzeyen, gönderime hazır yanıt önerileri",
      "Duygusal konuşmalarda bağlamı koruyan yönlendirmeler",
      "Uzun yazışmaları karara dönüştüren kısa özetler",
      "Her gün kullandığın mesaj ritmine uygun deneyim",
    ],
    missionTag: "Ürün vizyonu",
    missionHeading: "Daha az sürtüşme, daha net sonuç",
    missionDescription: "GossipAI, hem ilişkilerde hem iş tarafında daha isabetli iletişim kararları almanı destekler.",
    missionCta: "iOS'tan indir",
    howTag: "Basit ve net",
  ...
  en: {
    ...
    featuresRealmHeadingLine2: "Realms",
    featuresRealmHeadingLine3: "of Insight",
    featuresRealmDescription: "Go deeper into human communication patterns across both personal and professional contexts.",
    featuresRealmPersonalTitle: "Personal Life Insights",
    featuresRealmPersonalDescription:
      "Decode mixed signals, resolve lingering conflicts, and understand the deeper dynamics in friendships and dating.",
    featuresRealmProfessionalTitle: "Professional Strategy",
    featuresRealmProfessionalDescription:
      "Navigate office dynamics, read high-stakes conversations, and make sharper communication decisions at work.",
    valueTag: "Why teams use it",
    valueHeading: "Keep your speed, keep your clarity",
    valueDescription: "Stay fast in daily messaging without losing tone, intent, or control.",
    valueBullets: [
      "Ready-to-send suggestions that still sound like you",
      "Context-aware guidance for emotional conversations",
      "Short summaries that turn long threads into decisions",
      "Built for the messaging rhythm you already use",
    ],
    missionTag: "Product mission",
    missionHeading: "Less friction, clearer outcomes",
    missionDescription: "GossipAI helps you make sharper communication decisions in both relationships and work.",
    missionCta: "Download for iOS",
  ...
  de: {
    ...
    featuresRealmHeadingLine2: "Bereiche",
    featuresRealmHeadingLine3: "der Einsicht",
    featuresRealmDescription: "Verstehe Kommunikationsmuster tiefer in privaten und beruflichen Gespraechen.",
    featuresRealmPersonalTitle: "Einblicke ins Privatleben",
    featuresRealmPersonalDescription:
      "Gemischte Signale deuten, offene Konflikte klaeren und die Dynamik von Freundschaft und Dating besser verstehen.",
    featuresRealmProfessionalTitle: "Berufliche Strategie",
    featuresRealmProfessionalDescription:
      "Buerodynamiken lesen, kritische Meetings besser steuern und Kommunikation im Job praeziser planen.",
    valueTag: "Warum Teams es nutzen",
    valueHeading: "Schnell bleiben, klar kommunizieren",
    valueDescription: "Behalte dein Tempo im Alltag, ohne Ton, Absicht oder Klarheit zu verlieren.",
    valueBullets: [
      "Versandfertige Vorschläge, die nach dir klingen",
      "Kontextstarke Hinweise für emotionale Gespräche",
      "Kurze Zusammenfassungen, die Entscheidungen erleichtern",
      "Für deinen täglichen Nachrichtenrhythmus gebaut",
    ],
    missionTag: "Produktmission",
    missionHeading: "Weniger Reibung, klarere Ergebnisse",
    missionDescription: "GossipAI unterstützt dich dabei, in Beziehungen und im Job bessere Kommunikationsentscheidungen zu treffen.",
    missionCta: "Für iOS laden",
  ...
  fr: {
    ...
    featuresRealmHeadingLine2: "distincts",
    featuresRealmHeadingLine3: "d'analyse",
    featuresRealmDescription: "Approfondissez les dynamiques de communication dans votre vie personnelle et professionnelle.",
    featuresRealmPersonalTitle: "Insights vie personnelle",
    featuresRealmPersonalDescription:
      "Decodez les signaux mixtes, apaisez les tensions et comprenez mieux les dynamiques relationnelles.",
    featuresRealmProfessionalTitle: "Strategie professionnelle",
    featuresRealmProfessionalDescription:
      "Lisez les dynamiques d'equipe, gerez les conversations sensibles et avancez avec une communication plus nette.",
    valueTag: "Pourquoi les équipes l'utilisent",
    valueHeading: "Restez rapide, restez clair",
    valueDescription: "Gardez le rythme des messages quotidiens sans perdre le ton, l'intention ni la clarté.",
    valueBullets: [
      "Suggestions prêtes à envoyer qui gardent votre style",
      "Guidance contextuelle pour les conversations émotionnelles",
      "Résumés courts qui transforment les longs fils en décisions",
      "Conçu pour votre rythme de messagerie quotidien",
    ],
    missionTag: "Mission produit",
    missionHeading: "Moins de friction, des résultats plus clairs",
    missionDescription: "GossipAI vous aide à prendre de meilleures décisions de communication, au travail comme dans vos relations.",
    missionCta: "Télécharger sur iOS",
  ...
  it: {
    ...
    featuresRealmHeadingLine2: "distinte",
    featuresRealmHeadingLine3: "di analisi",
    featuresRealmDescription: "Approfondisci i pattern comunicativi nella vita personale e nel lavoro.",
    featuresRealmPersonalTitle: "Insight vita personale",
    featuresRealmPersonalDescription:
      "Interpreta segnali misti, sciogli tensioni aperte e comprendi meglio le dinamiche relazionali.",
    featuresRealmProfessionalTitle: "Strategia professionale",
    featuresRealmProfessionalDescription:
      "Leggi meglio le dinamiche d'ufficio, gestisci conversazioni critiche e comunica con maggiore precisione.",
    valueTag: "Perché i team lo usano",
    valueHeading: "Veloci nel flusso, chiari nel tono",
    valueDescription: "Mantieni il ritmo dei messaggi quotidiani senza perdere chiarezza, intenzione o controllo.",
    valueBullets: [
      "Suggerimenti pronti all'uso che restano nel tuo stile",
      "Guida contestuale per conversazioni emotive",
      "Sintesi brevi che trasformano thread lunghi in decisioni",
      "Pensato per il tuo ritmo quotidiano di messaggistica",
    ],
    missionTag: "Missione prodotto",
    missionHeading: "Meno attrito, risultati più chiari",
    missionDescription: "GossipAI ti aiuta a prendere decisioni di comunicazione migliori, nelle relazioni e nel lavoro.",
    missionCta: "Scarica su iOS",
  ...
  es: {
    ...
    featuresRealmHeadingLine2: "clave",
    featuresRealmHeadingLine3: "de analisis",
    featuresRealmDescription: "Profundiza en los patrones de comunicacion en tu vida personal y profesional.",
    featuresRealmPersonalTitle: "Insights de vida personal",
    featuresRealmPersonalDescription:
      "Descifra senales mixtas, resuelve tensiones pendientes y entiende mejor las dinamicas relacionales.",
    featuresRealmProfessionalTitle: "Estrategia profesional",
    featuresRealmProfessionalDescription:
      "Lee mejor la dinamica de oficina, gestiona conversaciones criticas y comunica con mas precision.",
    valueTag: "Por qué los equipos lo usan",
    valueHeading: "Rapidez en el flujo, claridad al comunicar",
    valueDescription: "Mantén el ritmo diario de mensajes sin perder tono, intención ni claridad.",
    valueBullets: [
      "Sugerencias listas para enviar que suenan como tú",
      "Guía contextual para conversaciones emocionales",
      "Resúmenes breves que convierten hilos largos en decisiones",
      "Diseñado para tu ritmo diario de mensajería",
    ],
    missionTag: "Misión del producto",
    missionHeading: "Menos fricción, resultados más claros",
    missionDescription: "GossipAI te ayuda a tomar mejores decisiones de comunicación en relaciones y trabajo.",
    missionCta: "Descargar en iOS",
