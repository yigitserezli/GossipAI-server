...
export default function AuroraShader({
  ...
  useEffect(() => {
    ...
    const shouldAnimate = () => !reduceMotionRef.current && !document.hidden;
    ...
    // Paint at least one frame before signaling readiness.
    renderFrame(0);
    signalReady();
  ...
  }, [amplitude, blend, colorStops, onReady, speed]);
